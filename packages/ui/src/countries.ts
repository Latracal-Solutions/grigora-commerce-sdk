import { COUNTRY_CODES } from "@grigora/commerce-core";

/** ISO 3166-1 alpha-2 codes with display names, in the API's accepted set. */
const ALL_COUNTRIES: ReadonlyArray<readonly [code: string, name: string]> = [
  ...
  ["GY", "Guyana"], ["HT", "Haiti"], ["HM", "Heard Island and McDonald Islands"], ["VA", "Vatican City"], ["HN", "Honduras"],
  ...
  ["US", "United States"], ["UM", "U.S. Outlying Islands"], ["UY", "Uruguay"], ["UZ", "Uzbekistan"], ["VU", "Vanuatu"],
  ["VE", "Venezuela"], ["VN", "Vietnam"], ["VG", "British Virgin Islands"], ["VI", "U.S. Virgin Islands"], ["WF", "Wallis and Futuna"],
  ["EH", "Western Sahara"], ["YE", "Yemen"], ["ZM", "Zambia"], ["ZW", "Zimbabwe"],
];

export const COUNTRIES: ReadonlyArray<readonly [code: string, name: string]> = ALL_COUNTRIES.filter(([code]) => COUNTRY_CODES.has(code));
